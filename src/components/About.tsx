...
const About = () => {
  return (
    <section id="about" className="section-padding bg-genosta-purple/5">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-white rounded-xl p-6 shadow-md card-hover">
            <div className="w-12 h-12 bg-genosta-purple-vivid/10 rounded-full flex items-center justify-center mb-4">
              <Users className="text-genosta-purple-vivid" size={24} />
            </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-md card-hover">
            <div className="w-12 h-12 bg-genosta-purple-vivid/10 rounded-full flex items-center justify-center mb-4">
              <Code className="text-genosta-purple-vivid" size={24} />
            </div>
